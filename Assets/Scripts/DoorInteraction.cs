...
public class DoorInteraction : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (!blockaction&&isInDoorColliderInteraction)
        {
            ...
            if (isInDoorColliderInteraction && doorInterraction && !locked && CharacterManager.instance.objectTocarry != null && CharacterManager.instance.objectTocarry.GetComponent<ObjectToCarry>().id == this.id)
            {
